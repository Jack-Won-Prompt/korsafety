...
<body>
    <div class="box">
        <img src="{{ asset('brand/logo-wordmark-light.png') }}" alt="(주)한국안전" style="height:40px;margin-bottom:30px">
        <div class="ico">
        ...
        <p>서비스 처리 중 문제가 발생했습니다.<br>잠시 후 다시 시도해 주세요. 문제가 계속되면 고객센터({{ config('company.tel') }})로 문의해 주세요.</p>
        <div class="btns">
