    ...
    <form class="auth-card wide" action="{{ route('purchaser.apply.post') }}" method="post">
        ...
        <div class="form-2">
            <div class="form-row"><label>상호명 <span class="req">*</span></label>
                <input class="input" name="company_name" value="{{ old('company_name') }}" placeholder="예) OO메디컬"></div>
        ...
        <div class="form-row"><label>이메일 (로그인 ID) <span class="req">*</span></label>
            <input class="input" type="email" name="email" value="{{ old('email') }}" placeholder="buyer-agent@example.com"></div>
        <div class="form-2">
        ...
        <button class="btn btn-accent" type="submit" style="width:100%;height:50px;margin-top:6px">구매 대행자 신청하기</button>
